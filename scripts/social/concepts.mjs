...
export const CONCEPTS = [
  ...
  },
  {
    ...
    headline: "25% off",
    headlineSize: 112,
    logo: "images/barnes-and-noble.svg",
    code: "PREORDER25",
    sub: "September 9 through 11, 2026. The Midnight Coder's Children by Prashant Sridharan.",
    url: "midnightcoderschildren.com/buy",
    href: "/buy",
    ribbon: "Pre-order now",
    markCode: true,
  },
  {
    ...
    headlineSize: 108,
    hook: "The Midnight Coder's Children",
    sub: "A novel by Prashant Sridharan.",
    url: "midnightcoderschildren.com/buy",
    href: "/buy",
  },
  {
    ...
    headlineSize: 100,
    hook: "Enter to win",
    sub: "The Midnight Coder's Children by Prashant Sridharan.",
    url: "goodreads.com/giveaway",
