...
const BOOK_BLURB: Paragraph[] = [
  [
    { text: "The ", type: "text" },
    { text: "encrypted secrets", type: "string" },
    { text: " of a ", type: "text" },
    { text: "brilliant", type: "function" },
    { text: " ", type: "text" },
    { text: "coder", type: "type" },
    { text: "'s life ", type: "text" },
    { text: "become", type: "keyword" },
    { text: " the only hope to ", type: "text" },
    { text: "thwart", type: "keyword" },
    { text: " a ", type: "text" },
    { text: "catastrophic", type: "function" },
    { text: " cyberattack ", type: "text" },
    { text: "threatening", type: "keyword" },
    { text: " the ", type: "text" },
  ...
  [
    ...
    { text: "'s children and ", type: "text" },
    { text: "former", type: "function" },
    { text: " colleagues must ", type: "text" },
    { text: "navigate", type: "keyword" },
    { text: " her life as an ", type: "text" },
    ...
    { text: " to ", type: "text" },
    { text: "unlock", type: "keyword" },
    { text: " the ", type: "text" },
    { text: "complex", type: "function" },
    { text: " ", type: "text" },
    { text: "security measures", type: "string" },
    { text: " she left behind to ", type: "text" },
    { text: "protect", type: "keyword" },
    { text: " them, ", type: "text" },
    { text: "revealing", type: "keyword" },
    { text: " a path not only to ", type: "text" },
    { text: "saving", type: "keyword" },
    { text: " their company but also to ", type: "text" },
    { text: "understanding", type: "keyword" },
    { text: " the ", type: "text" },
    { text: "sacrifices", type: "type" },
    { text: " and ", type: "text" },
    { text: "strength", type: "type" },
    { text: " of a woman who ", type: "text" },
    { text: "anticipated", type: "keyword" },
    { text: " and ", type: "text" },
    { text: "shaped", type: "keyword" },
    { text: " their world.", type: "text" },
  ],
];
